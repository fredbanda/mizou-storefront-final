const TermsAndConditions = () => {
  return (
    <div className="flex flex-col gap-6 p-6 text-left max-w-4xl mx-auto">
      <h1 className="text-heading2-bold font-bold mb-4 text-center">
        Terms and Conditions
      </h1>

      <h3 className="text-center text-heading3-bold">Overview</h3>

      <p className="text-base leading-relaxed">
        This website is operated by mizou.co.za. Throughout the site, the terms
        “we”, “us” and “our” refer to mizou.co.za. mizou.co.za offers this
      ...
      <div className="bg-emerald-100 p-4 border-l-4 border-emerald-500">
        <h2 className="font-semibold">New Features:</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-blue-100 p-4 border-l-4 border-blue-500">
        <h2 className="font-semibold">Section 1: Online Store Terms</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-pink-100 p-4 border-l-4 border-pink-500">
        <h2 className="font-semibold">
      ...
      <div className="bg-orange-100 p-4 border-l-4 border-orange-500">
        <h2 className="font-semibold">SECTION 7 - OPTIONAL TOOLS</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-orange-100 p-4 border-l-4 border-orange-500">
        <h2 className="font-semibold"> SECTION 8 - THIRD-PARTY LINKS </h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-purple-100 p-4 border-l-4 border-purple-500">
        ...
        <p className="mt-2 text-sm leading-relaxed">
          ...
          objectionable or violates any party&pos;s intellectual property or these
          ...
          any related website. You may not use a false email address, pretend
      ...
      <div className="bg-red-100 p-4 border-l-4 border-red-500">
        <h2 className="font-semibold"> SECTION 10 - PERSONAL INFORMATION</h2>
        <p className="mt-2 text-sm leading-relaxed">
          Your submission of personal information through the store is governed
          by our Privacy Policy which governed by POPIA,
        </p>
      </div>
      <div className="bg-purple-100 p-4 border-l-4 border-purple-500">
        <h2 className="font-semibold">
      ...
      <div className="bg-red-100 p-4 border-l-4 border-red-500">
        <h2 className="font-semibold"> SECTION 12 - PROHIBITED USES</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-red-100 p-4 border-l-4 border-red-500">
        ...
        <p className="mt-2 text-sm leading-relaxed">
          ...
          non-infringement. In no case shall mizou.co.za, our directors,
      ...
      <div className="bg-pink-100 p-4 border-l-4 border-pink-500">
        <h2 className="font-semibold">SECTION 14 - INDEMNIFICATION</h2>
        <p className="mt-2 text-sm leading-relaxed">
          You agree to indemnify, defend and hold harmless mizou.co.za and our
          ...
          or the rights of a third-party.SECTION 14 - INDEMNIFICATION You agree
          to indemnify, defend and hold harmless mizou.co.za and our parent,
      ...
      <div className="bg-slate-100 p-4 border-l-4 border-slate-500">
        <h2 className="font-semibold">SECTION 15 - SEVERABILITY</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-slate-100 p-4 border-l-4 border-slate-500">
        <h2 className="font-semibold">SECTION 16 - TERMINATION</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-yellow-100 p-4 border-l-4 border-yellow-500">
        <h2 className="font-semibold">SECTION 17 - ENTIRE AGREEMENT</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-yellow-100 p-4 border-l-4 border-yellow-500">
        <h2 className="font-semibold"> SECTION 18 - GOVERNING LAW</h2>
        <p className="mt-2 text-sm leading-relaxed">
      ...
      <div className="bg-gray-100 p-4 border-l-4 border-gray-500">
        ...
        <p className="mt-2 text-sm leading-relaxed">
          ...
          should be sent to us at mizoujewelry@gmail.com Our contact information
          is posted below: <br />
          <span className="text-bold">Mkhweli Consortium Pty ltd</span> <br />
          mizoujewelry@gmail.com 71 <br />
          Fairway Crescent. <br />Hole-in-one Avenue.<br /> Ruimsig. Roodepoort. 1732. 
          <br />South
          Africa. <br />
          [2017/005508/07] <br />
          [9248423221] <br />
           By consenting to Mizou.&apos;s SMS
          ...
          contact us at mizoujewelry@gmail.com for more information. We have the
          right to modify any telephone number or short code we use to operate
          the service at any time. You will be notified on such occasions. You
          agree that any messages you send to a telephone number or short code
          we have changed, including any STOP or HELP requests, may not be
          received, and we will not be liable for honoring requests made in such
          messages. To the extent permitted by applicable law, you agree that we
          ...
          information or Service. Your right to privacy is important to us. You
          can see our Privacy Policy to determine how we collect and use your
